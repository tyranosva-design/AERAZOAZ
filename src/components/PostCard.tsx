...
export const PostCard: React.FC<PostCardProps> = ({
  ...
  return (
    <article className="group bg-white border border-zinc-300 hover:border-black transition-all flex flex-col justify-between h-full w-full p-3.5 sm:p-4 relative shadow-sm hover:shadow-md space-y-2.5">
      <div className="flex flex-col flex-1 justify-between space-y-2.5">
        <div>
          ...
          <div className="flex items-center justify-between mb-2.5 border-b border-zinc-200 pb-2">
            <div className="flex flex-wrap items-center gap-1.5">
              ...
              <Link
                href={`/${categorySlug}`}
                className="font-heading font-bold text-[10px] sm:text-[11px] uppercase px-2 py-0.5 tracking-wider inline-block shrink-0 hover:opacity-80"
                style={{ 
              ...
              {hasTag && (
                <Link 
                  ...
                  className="text-[10px] sm:text-[11px] font-mono font-bold border border-zinc-300 text-zinc-800 bg-zinc-100 hover:bg-black hover:text-white hover:border-black px-1.5 py-0.5 uppercase shrink-0 truncate max-w-[130px] inline-flex items-center space-x-1 transition-colors"
          ...
          {post.featuredImage && (
            <Link 
              href={postUrl}
              className="w-full aspect-[851/315] overflow-hidden bg-zinc-100 border border-zinc-300 mb-2.5 cursor-pointer relative group/img shrink-0 block"
            >
              <img
          ...
          <h3 className="text-xs sm:text-sm font-bold font-heading text-black tracking-tight leading-snug mb-1.5 hover:underline cursor-pointer uppercase break-words line-clamp-3">
          ...
          <p className="text-zinc-600 text-[11px] sm:text-xs font-body leading-relaxed mb-2.5 break-words line-clamp-4">
            {formattedExcerpt}
          </p>
        </div>
      </div>
      ...
      <div className="pt-2 border-t border-zinc-200 flex items-center justify-between font-mono text-[10px] sm:text-[11px] text-zinc-500 mt-auto shrink-0">
        ...
        <Link
          href={postUrl}
          className="flex items-center space-x-1 text-black font-heading font-extrabold hover:underline cursor-pointer uppercase tracking-wider min-h-[26px]"
        >
          <span>VIEW DATA</span>
