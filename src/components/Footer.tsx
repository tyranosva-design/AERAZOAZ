          ...
          <div className="md:col-span-5 space-y-3 sm:space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <Link
                ...
                prefetch={true}
                onClick={onOpenAbout}
                className="bg-black text-white hover:bg-zinc-800 text-[10px] sm:text-xs font-mono font-bold uppercase px-3 py-2 border border-black transition-colors cursor-pointer inline-flex items-center justify-center min-h-[44px]"
              >
                READ ABOUT OUR DESK →
              </Link>
            </div>
            ...
            <div className="pt-4 border-t border-zinc-200">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <a
                  ...
                  title="Instagram"
                  className="flex items-center space-x-1.5 bg-zinc-50 hover:bg-black hover:text-white text-black border border-black px-3 py-2 text-xs font-bold transition-colors cursor-pointer min-h-[38px]"
                >
              ...
              {(Object.keys(CATEGORY_THEMES) as CategoryType[]).map((catKey) => {
                ...
                return (
                  <Link
                    ...
                    prefetch={true}
                    className="flex items-center space-x-2.5 hover:underline text-zinc-800 hover:text-black cursor-pointer uppercase font-heading text-xs py-1.5 min-h-[36px] w-full text-left"
                  >
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <div className="space-y-2 text-xs">
              <Link
                ...
                className="flex items-center space-x-2 hover:underline text-zinc-800 hover:text-black cursor-pointer font-mono py-1 min-h-[36px]"
              >
              ...
              <Link
                href="/contact"
                prefetch={true}
                className="flex items-center space-x-2 hover:underline text-zinc-800 hover:text-black cursor-pointer font-mono py-1 font-bold pt-1 text-black min-h-[36px]"
              >
